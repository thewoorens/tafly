  ...
  <div class="h-full">
    <div v-if="isSidebarOpen"
      ...
      <div class="w-full px-2">
        <div class="flex flex-col items-center w-full mt-3 border-t border-gray-300">
          <router-link active-class="bg-gray-200" to="/" class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300">
          ...
          <router-link to="/*" active-class="bg-gray-200" class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300">
            ...
            <span class="ml-2 text-sm font-medium">{{ $t('sidebar.search') }}</span>
          </router-link>
          <router-link to="/stats" active-class="bg-gray-200" class="flex items-center w-full h-12 px-3 mt-2 hover:bg-gray-300 rounded" href="#">
            <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                 stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="flex flex-col items-center w-full mt-2 border-t border-gray-300">
          <router-link to="/products" active-class="bg-gray-200" class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300">
          ...
          <router-link to="/messages" active-class="bg-gray-200" class="relative flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" href="#">
            <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                 stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"/>
            </svg>
            <span class="ml-2 text-sm font-medium">{{ $t('sidebar.messages') }}</span>
    ...
    <div v-else class="flex flex-col items-center w-16 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
      ...
      <div class="flex flex-col items-center mt-3 border-t border-gray-300">
        <router-link to="/" active-class="bg-gray-200" class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-gray-300" href="#">
          <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
               stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
